  ...
  public void processNormalProtocol() throws Exception {
	...
	for (int i = 0; i < rfb.updateNRects; i++) {
	  ...
	  case RfbProto.EncodingTight:
	    ...
	    break;
    case RfbProto.EncodingExtendedKeyEvent:
      if (!KeyboardEvent.extended_key_event) {
        System.out.println("Enable extended key event" );
...
//    System.out.println("Pressed: char '"+evt.getKeyChar()+"' keycode='"+ evt.getKeyCode()
...
//    System.out.println("Released: char '"+evt.getKeyChar()+"' keycode='"+ evt.getKeyCode()
//        +"'  ext='"+evt.getExtendedKeyCode()
//        +"' ext_for_char='"+KeyEvent.getExtendedKeyCodeForChar( evt.getKeyChar() ) +"'" );
...
//    System.out.println("Key typed: char '"+evt.getKeyChar()+"' keycode='"+ evt.getKeyCode()
//        +"'  ext='"+evt.getExtendedKeyCode()
//        +"' ext_for_char='"+KeyEvent.getExtendedKeyCodeForChar( evt.getKeyChar() ) +"'" );
